...
class Settings(BaseSettings):
    ...
    navigator_db_password: str = "postgres"
    navigator_access_login: str = "admin"
    ...
    visiology_username: str = "user"
    visiology_password: str = "Visiology3User"
    ...
    visiology_verify_ssl: bool = False
    ...
    oidc_issuer: str = "https://dev-lk.tot.technology/idp/"             # e.g. https://assistant.sberanalytics.ru/api_sso/
    oidc_client: str = "dev_img2bi"                                     # e.g. dev_img2bi

    oidc_secret: str = "CkFaOyNG89ASq7J1L"                              # client secret
    oidc_sync_every_sec: int = 60                                       # token refresh interval
    oidc_redirect_uri: str = "http://172.21.101.56:5000/api/oidc/callback"   # override redirect_uri, e.g. http://172.21.101.72:5000/api/oidc/callback
